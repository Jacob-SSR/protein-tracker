...
migration ล่าสุด (`gender_condition_weight_basis_last_login`) เป็นแบบเพิ่มอย่างเดียว
มี default ครบทุกคอลัมน์ ไม่ต้องล้างฐานข้อมูล รันได้เลย:
...
| ผู้ใช้ | สร้างบัญชีผู้ป่วย/ผู้ดูแล, รีเซ็ตรหัสผ่าน, ปิด-เปิดใช้งาน, ดูเวลาเข้าใช้ล่าสุด |
